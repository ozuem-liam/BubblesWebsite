  ...
  return (
    <div className='overflow-hidden'>
      ...
      <div className='space-y-6'>
        ...
        {/* Order Totals */}
        <div className='bg-white rounded-xl p-4 border border-gray-200 md:w-[40%] w-full ms-auto'>
          <div className='space-y-3'>
        ...
        <Button
          onClick={onCheckout}
          disabled={
            !cart || cart.items.length === 0 || !selectedDelivery || loading
          }
          className='h-12 bg-blue-600 hover:bg-blue-700 text-white rounded-lg shadow-sm md:w-[40%] flex w-full ms-auto'
          size='lg'
        >
          {loading ? (
