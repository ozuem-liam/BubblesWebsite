      ...
      <div className='p-4 grid grid-cols-1 lg:grid-cols-2 gap-8'>
        ...
        <div className='lg:col-span-1'>
          <div className='mb-6'>
            <Text
              as='h3'
              style='text-gray-700 text-lg font-semibold mb-4 flex items-center gap-2'
            >
          ...
          <div className='bg-blue-50 rounded-xl p-4 border border-blue-100'>
            <Text
              as='h3'
              style='text-gray-700 text-lg font-semibold mb-3 flex items-center gap-2'
            >
          ...
          <div className='space-y-6'>
                ...
                {isExpressSelected ? (
                  <div className='space-y-4'>
                    <DatePicker
                      ...
                      dayClassName={(date) =>
                        date.getDate() ===
                        new Date(selectedDeliveryDate || '').getDate()
                  ...
                  <div className='space-y-3'>
                    <Select
                      ...
                      onValueChange={(value: string) =>
                        setSelectedTimeSlot(value || null)
                      }
                    >
                  ...
                  >
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        ...
                        <Text as='p' style='text-gray-500 text-sm'>
                          Use your wallet for instant payment
                        </Text>
                      </div>
                    </div>
                  </div>
            ...
            >
              {loading ? (
                ...
                `Pay ${formatNaira(total)} with ${
                  selectedPaymentMethod === 'paystack' ? 'Card' : 'Wallet'
                }`
              )}
            </Button>
          </div>
