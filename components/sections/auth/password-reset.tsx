...
export const PasswordReset = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#001a3f] p-4">
      <div className="bg-[#00112b] rounded-lg border border-[#1a3b6d] p-8 w-full max-w-md">
        {/* Header */}
        <div className="text-center mb-6">
          ...
          <p className="text-gray-300 mt-2">
            ...
            {currentStep === "verify-otp" && "Enter the code sent to your email"}
            {currentStep === "reset-password" && "Create a new password for your account"}
        ...
        {currentStep === "email" && (
          <form onSubmit={handleSendOtp} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded flex justify-center ${
