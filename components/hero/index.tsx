...
export const Hero: React.FC = () => {
  return (
    <div className="lg:px-[2.5rem] px-4 bg_linear-gradient lg:pt-[6rem] pt-[12rem]">
      <TopNav />
      <MaxScreenWrapper style="pt-[4rem] pb-[6rem] flex lg:flex-row flex-col items-center gap-[40px] justify-between">
        <div className="flex flex-col gap-[24px] lg:w-[40%] w-full lg:items-start items-center">
          ...
          <RevealAnimation style="w-fit">
            <Text
              id="home"
              style="lg:text-start text-center text-[72px] font-[800] leading-[120%] text-tertiary100"
            >
              Laundry Made Simple For You
            </Text>
          </RevealAnimation>
          <RevealAnimation style="w-fit">
            <Text style="lg:text-start text-center text-tertiary700 text-[20px] font-[400] leading-[140%]">
