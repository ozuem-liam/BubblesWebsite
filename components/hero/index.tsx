...
const heroSlides = [
  {
    ...
    bgGradient: "from-primary900/20 via-primary800/10 to-transparent"
  },
  {
  ...
  },
  {
    ...
    bgGradient: "from-green-900/20 via-green-800/10 to-transparent"
  }
];
...
export const Hero: React.FC = () => {
  ...
  return (
    <div className="lg:px-[2.5rem] xl:px-[5.5rem] px-4 bg_linear-gradient lg:pt-[3rem] pt-[10rem] relative overflow-hidden">
      ...
      <div 
        className={`absolute inset-0 bg-gradient-to-br transition-all duration-1000 ease-in-out ${heroSlides[activeSlide]?.bgGradient || heroSlides[0].bgGradient}`}
      />
            ...
            <SwiperSlide key={index}>
              <div className="flex lg:flex-row flex-col items-center md:gap-[40px] gap-[20px] justify-between">
                ...
                <div className="flex flex-col gap-[24px] lg:w-[40%] xl:w-[50%] w-full lg:items-start items-center">
                  ...
                  <RevealAnimation style="w-fit">
                    <div className={`transform transition-all duration-700 delay-150 ease-out ${isTransitioning ? 'translate-y-4 opacity-0' : 'translate-y-0 opacity-100'}`}>
                      <Text
                        id="home"
                        style="lg:text-start text-center md:text-[72px] text-[42px] font-[800] leading-[120%] text-tertiary100 drop-shadow-lg"
                      >
                        {slide.title}
                      </Text>
                    </div>
                ...
                <RevealAnimation style="lg:w-[60%] xl:w-[50%] w-full">
                  <div className={`transform transition-all duration-1000 ease-out ${isTransitioning ? 'scale-95 opacity-80' : 'scale-100 opacity-100'}`}>
                    <CustomImage
                      src={heroImg}
                      style="w-full lg:h-[776px] h-[400px] drop-shadow-2xl"
                      imgStyle="object-contain transition-transform duration-700 hover:scale-[1.02]"
                      priority={index === 0}
                    />
                  </div>
                </RevealAnimation>
